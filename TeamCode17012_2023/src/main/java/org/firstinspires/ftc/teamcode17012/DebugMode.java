...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void checkDriverController() {
        ...
        // Single Button motor control
        if (gamepad1.triangle) {
            drivetrain.setMotorPower(1,0,0,0);
        } else if (gamepad1.circle) {
            drivetrain.setMotorPower(0,1,0,0);
        } else if (gamepad1.square) {
            drivetrain.setMotorPower(0,0,1,0);
        } else if (gamepad1.cross) {
            drivetrain.setMotorPower(0, 0, 0, 1);
        } else {
