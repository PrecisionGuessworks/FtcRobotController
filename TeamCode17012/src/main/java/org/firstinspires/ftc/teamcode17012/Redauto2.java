...
//////////////////////////////////////////////////////////////////////////////////////////
@Autonomous(name="Red auto 2.0", group="Tank")
...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void runOpMode() {
        ...
        drivetrain.mecanumDrive_Cartesian(0.7, 0.0, 0.0);
        utilities.delay(1000);
        drivetrain.mecanumDrive_Cartesian(0.0, 0.0, -0.7);
        utilities.delay(500);
        drivetrain.mecanumDrive_Cartesian(0.0, -0.7, 0.0);
        utilities.delay(1000);
        drivetrain.mecanumDrive_Cartesian(0.0, 0.0, 0.0);
        duckSpinner.setDuckMotorPower(.5);
        utilities.delay( 3000 );
        duckSpinner.setDuckMotorPower(0.0);
        drivetrain.mecanumDrive_Cartesian(0.0,0.7,0.0);
        utilities.delay(1000);
        drivetrain.mecanumDrive_Cartesian(0.0,0.0,0.7);
        utilities.delay(1520);
        drivetrain.mecanumDrive_Cartesian(0.0,-0.7,0.0);
        utilities.delay(5500);
    }
